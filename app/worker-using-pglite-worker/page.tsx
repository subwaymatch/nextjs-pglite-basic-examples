...
export default function WorkerExample2() {
  ...
  return (
    <div className="p-4 max-w-xl">
      ...
      <p className="mt-4">
        This example does not work with Turbopack when running via{" "}
        <code className="whitespace-nowrap">next dev --turbopack</code>. To use
        workers with PGlite, ensure you omit the{" "}
        <code className="whitespace-nowrap">--turbopack</code> flag.
      </p>
      ...
      <button
        className="bg-black text-white font-semibold py-2 px-4 rounded mt-4 hover:bg-neutral-800"
        onClick={sendQuery}
      >
        Click to Send Query
      </button>
      ...
      <div className="mt-12 border-t border-gray-300 py-4">
        <a
          href="https://github.com/subwaymatch/nextjs-pglite-basic-examples/tree/main/app/worker-using-pglite-worker"
          target="_blank"
